...
__device__ void __update(float * dists, int * dists_i, int idx1, 
    int idx2){
      float v1 = dists[idx1], v2 = dists[idx2];
      int i1 = dists_i[idx1], i2 = dists_i[idx2];
