...
class GTDatabaseGenerator(KittiDataset):
    ...
    def generate_gt_database(self):
        ...
        for idx, sample_id in enumerate(self.image_idx_list):
            ...
            boxes_pts_mask_list = roipool3d_utils.pts_in_boxes3d_cpu(paddle.to_tensor(pts_rect), paddle.to_tensor(gt_boxes3d))
...
if __name__ == '__main__':
    ...
    dataset = GTDatabaseGenerator(root_dir='/home/cxl/PaperContest/PointRCNN/data/', split=args.split)
